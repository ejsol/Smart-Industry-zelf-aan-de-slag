...
print("                               ")
print("time stamp                trigger  warehouse-state outside-door  inside-door  open/close %  out/in door %")
...
while True:
    try:
        ...
        print(time_stamp.get_value(), "  ", trigger.get_value(), "  ", warehouse_state.get_value(), "          ",
            ...
            open_percentage.get_value(), "       ", door_share_percentage.get_value() )
        time.sleep(5)
