...
# start from windows in a windowed terminal-mode and use from other computer opc client to read data froom this opc server
...
class MyGroveOpcApp(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.btn_stop = tk.Button(self.master, text="Stop running program", font=fontlabel)
