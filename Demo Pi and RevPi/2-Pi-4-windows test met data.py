...
class MyGroveStandAloneApp(tk.Frame):
    ...
    def __init__(self, master=None):
        ...
        self.btn_stop.grid(row=4, column=1)
    ...
    def on_press_main(self):
        ...
        self.lbl_airq.config(text="Air " + str(int(self.sensor_air_value)))
        self.lbl_o_temp.config(text="Out (C)loss: " + str(int(self.sensor_o.temperature)))
        self.lbl_w_temp.config(text="WareHouse : " + str(int(self.sensor_w.temperature)))
